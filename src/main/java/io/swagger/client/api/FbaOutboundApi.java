...
public class FbaOutboundApi {
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call deliveryOffersCall(GetDeliveryOffersRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, LWAException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deliveryOffersValidateBeforeCall(GetDeliveryOffersRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = deliveryOffersCall(body, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<GetDeliveryOffersResponse> deliveryOffersWithHttpInfo(GetDeliveryOffersRequest body) throws ApiException,LWAException {
        com.squareup.okhttp.Call call = deliveryOffersValidateBeforeCall(body, null, null);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call deliveryOffersAsync(GetDeliveryOffersRequest body, final ApiCallback<GetDeliveryOffersResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = deliveryOffersValidateBeforeCall(body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetDeliveryOffersResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param queryStartDate A date that you can use to select inventory that has been updated since a specified date. An update is defined as any change in feature-enabled inventory availability. The date must be in the format yyyy-MM-ddTHH:mm:ss.sssZ (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getFeatureInventoryCall(String marketplaceId, String featureName, String nextToken, OffsetDateTime queryStartDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, LWAException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getFeatureInventoryValidateBeforeCall(String marketplaceId, String featureName, String nextToken, OffsetDateTime queryStartDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getFeatureInventoryCall(marketplaceId, featureName, nextToken, queryStartDate, progressListener, progressRequestListener);
        return call;
    ...
    public GetFeatureInventoryResponse getFeatureInventory(String marketplaceId, String featureName, String nextToken, OffsetDateTime queryStartDate) throws ApiException,LWAException {
        ApiResponse<GetFeatureInventoryResponse> resp = getFeatureInventoryWithHttpInfo(marketplaceId, featureName, nextToken, queryStartDate);
        return resp.getData();
    }
    ...
    public ApiResponse<GetFeatureInventoryResponse> getFeatureInventoryWithHttpInfo(String marketplaceId, String featureName, String nextToken, OffsetDateTime queryStartDate) throws ApiException,LWAException {
        com.squareup.okhttp.Call call = getFeatureInventoryValidateBeforeCall(marketplaceId, featureName, nextToken, queryStartDate, null, null);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call getFeatureInventoryAsync(String marketplaceId, String featureName, String nextToken, OffsetDateTime queryStartDate, final ApiCallback<GetFeatureInventoryResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = getFeatureInventoryValidateBeforeCall(marketplaceId, featureName, nextToken, queryStartDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetFeatureInventoryResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param language The language that the &#x60;TranslatedDescription&#x60; property of the &#x60;ReasonCodeDetails&#x60; response object should be translated into. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    private com.squareup.okhttp.Call listReturnReasonCodesValidateBeforeCall(String sellerSku, String marketplaceId, String sellerFulfillmentOrderId, String language, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listReturnReasonCodesCall(sellerSku, marketplaceId, sellerFulfillmentOrderId, language, progressListener, progressRequestListener);
        return call;
    ...
    public ListReturnReasonCodesResponse listReturnReasonCodes(String sellerSku, String marketplaceId, String sellerFulfillmentOrderId, String language) throws ApiException,LWAException {
        ApiResponse<ListReturnReasonCodesResponse> resp = listReturnReasonCodesWithHttpInfo(sellerSku, marketplaceId, sellerFulfillmentOrderId, language);
        return resp.getData();
    }
    ...
    public ApiResponse<ListReturnReasonCodesResponse> listReturnReasonCodesWithHttpInfo(String sellerSku, String marketplaceId, String sellerFulfillmentOrderId, String language) throws ApiException,LWAException {
        com.squareup.okhttp.Call call = listReturnReasonCodesValidateBeforeCall(sellerSku, marketplaceId, sellerFulfillmentOrderId, language, null, null);
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public com.squareup.okhttp.Call listReturnReasonCodesAsync(String sellerSku, String marketplaceId, String sellerFulfillmentOrderId, String language, final ApiCallback<ListReturnReasonCodesResponse> callback) throws ApiException, LWAException {
        ...
        com.squareup.okhttp.Call call = listReturnReasonCodesValidateBeforeCall(sellerSku, marketplaceId, sellerFulfillmentOrderId, language, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ListReturnReasonCodesResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
