...
public class Dimensions {
   ...
   * @return length
  **/
  @ApiModelProperty(required = true, value = "The length of the package.")
   ...
   * @return width
  **/
  @ApiModelProperty(required = true, value = "The width of the package.")
   ...
   * @return height
  **/
  @ApiModelProperty(required = true, value = "The height of the package.")
