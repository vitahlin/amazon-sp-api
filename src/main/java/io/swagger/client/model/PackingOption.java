...
import io.swagger.client.model.ShippingConfiguration;
...
public class PackingOption {
  ...
  **/
   ...
   * @return expiration
  **/
  @ApiModelProperty(value = "The time at which this packing option is no longer valid. In [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) datetime format with pattern `yyyy-MM-ddTHH:mm:ss.sssZ`.")
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "The status of the packing option. Possible values: `OFFERED`, `ACCEPTED`, `EXPIRED`.")
