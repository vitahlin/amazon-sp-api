...
import io.swagger.client.model.FeaturedOfferExpectedPriceResultList;
...
public class FeaturedOfferExpectedPriceResponseBody {
  ...
  **/
  @ApiModelProperty(value = "Metadata that identifies the target offer for which the featured offer expected price result data was computed.")
