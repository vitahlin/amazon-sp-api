...
import io.swagger.client.model.ItemBrowseClassificationsByMarketplace;
 ...
 */
@ApiModel(description = "Array of classifications (browse nodes) associated with the item in the Amazon catalog by Amazon marketplace.")
...
public class ItemBrowseClassifications extends ArrayList<ItemBrowseClassificationsByMarketplace> {
  ...
  public String toString() {
    ...
    sb.append("class ItemBrowseClassifications {\n");
