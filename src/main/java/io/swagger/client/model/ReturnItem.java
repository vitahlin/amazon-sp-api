...
import io.swagger.client.model.FulfillmentReturnItemStatus;
import io.swagger.client.model.ReturnItemDisposition;
...
public class ReturnItem {
  ...
  **/
  @ApiModelProperty(value = "Identifies the return authorization used to return this item. Refer to `ReturnAuthorization`.")
