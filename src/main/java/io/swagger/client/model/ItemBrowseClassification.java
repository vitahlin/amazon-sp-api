...
public class ItemBrowseClassification {
   ...
   * @return displayName
  **/
  @ApiModelProperty(required = true, value = "Display name for the classification (browse node).")
  ...
  **/
   ...
   * @return parent
  **/
  @ApiModelProperty(value = "Parent classification (browse node) of the current classification.")
