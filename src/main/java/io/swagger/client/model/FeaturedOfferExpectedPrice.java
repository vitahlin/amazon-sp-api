 ...
 */
@ApiModel(description = "The item price at or below which the target offer may be featured.")
...
public class FeaturedOfferExpectedPrice {
   ...
   * @return listingPrice
  **/
  @ApiModelProperty(required = true, value = "A computed listing price at or below which a seller can expect to become the featured offer (before applicable promotions).")
