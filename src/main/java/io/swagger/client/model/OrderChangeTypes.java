...
import io.swagger.client.model.OrderChangeTypeEnum;
 ...
 */
@ApiModel(description = "A list of order change types to subscribe to (for example: `BuyerRequestedChange`). To receive notifications of all change types, do not provide this list.")
