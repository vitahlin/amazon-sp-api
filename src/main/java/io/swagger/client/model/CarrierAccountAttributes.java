...
import io.swagger.client.model.CarrierAccountAttribute;
 ...
 */
@ApiModel(description = "A list of all attributes required by the carrier in order to successfully link the merchant's account")
...
public class CarrierAccountAttributes extends ArrayList<CarrierAccountAttribute> {
  ...
  public String toString() {
    ...
    sb.append("class CarrierAccountAttributes {\n");
