 ...
 */
@ApiModel(description = "Information required to create the report schedule.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2024-10-31T20:13:38.126+08:00")
public class CreateReportScheduleSpecification {
  ...
  **/
   ...
   * @return period
  **/
  @ApiModelProperty(required = true, value = "One of a set of predefined <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> periods that specifies how often a report should be created.")
  ...
  **/
  @ApiModelProperty(value = "The date and time when the schedule will create its next report, in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> date time format.")
