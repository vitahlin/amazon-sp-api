...
import io.swagger.client.model.FulfillmentPreviewItemList;
...
public class FulfillmentPreviewShipment {
  ...
  **/
  @ApiModelProperty(value = "The earliest date that the shipment is expected to be sent from the fulfillment center. Must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.")
  ...
  **/
  @ApiModelProperty(value = "The latest date that the shipment is expected to be sent from the fulfillment center. Must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.")
  ...
  **/
  @ApiModelProperty(value = "The latest date that the shipment is expected to arrive at its destination. Must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.")
