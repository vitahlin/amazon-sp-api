 ...
 */
@ApiModel(description = "ValidationMetadata Details")
...
public class ValidationMetadata {
   ...
   * @return errorMessage
  **/
  @ApiModelProperty(value = "errorMessage for the error.")
  ...
  **/
  @ApiModelProperty(value = "validationStrategy for the error.")
