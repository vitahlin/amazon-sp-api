 ...
 */
@ApiModel(description = "The `GenerateShipmentContentUpdatePreviews` request.")
...
public class GenerateShipmentContentUpdatePreviewsRequest {
   ...
   * @return boxes
  **/
  @ApiModelProperty(required = true, value = "A list of boxes that will be present in the shipment after the update.")
   ...
   * @return items
  **/
  @ApiModelProperty(required = true, value = "A list of all items that will be present in the shipment after the update.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GenerateShipmentContentUpdatePreviewsRequest generateShipmentContentUpdatePreviewsRequest = (GenerateShipmentContentUpdatePreviewsRequest) o;
