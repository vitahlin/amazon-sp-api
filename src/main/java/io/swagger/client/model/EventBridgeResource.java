 ...
 */
@ApiModel(description = "The Amazon EventBridge destination.")
...
public class EventBridgeResource {
  ...
  **/
   ...
   * @return region
  **/
  @ApiModelProperty(required = true, value = "The AWS region in which you receive the notifications. For AWS regions that are supported in Amazon EventBridge, refer to [Amazon EventBridge endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/ev.html).")
