...
public class DeliveryWindow {
   ...
   * @return startDate
  **/
  @ApiModelProperty(required = true, value = "The date and time of the start of the Scheduled Delivery window. Must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.")
   ...
   * @return endDate
  **/
  @ApiModelProperty(required = true, value = "The date and time of the end of the Scheduled Delivery window. Must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.")
