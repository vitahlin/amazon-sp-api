...
import io.swagger.client.model.EventCode;
import io.swagger.client.model.TrackingAddress;
...
public class TrackingEvent {
   ...
   * @return eventDate
  **/
  @ApiModelProperty(required = true, value = "The date and time that the delivery event took place. Must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.")
