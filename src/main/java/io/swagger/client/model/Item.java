...
import io.swagger.client.model.PrepInstruction;
...
public class Item {
  ...
  **/
   ...
   * @return expiration
  **/
  @ApiModelProperty(value = "The expiration date of the MSKU. In [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) datetime format with pattern`YYYY-MM-DD`. The same MSKU with different expiration dates cannot go into the same box.")
