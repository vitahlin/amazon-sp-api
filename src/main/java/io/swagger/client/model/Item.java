...
import io.swagger.client.model.FulfillmentAvailability;
import io.swagger.client.model.ItemAttributes;
import io.swagger.client.model.ItemIssues;
import io.swagger.client.model.ItemOffers;
import io.swagger.client.model.ItemProcurement;
...
public class Item {
  ...
  **/
  @ApiModelProperty(value = "The fulfillment availability for the listings item.")
   ...
   * @return procurement
  **/
  @ApiModelProperty(value = "The vendor procurement information for the listings item.")
