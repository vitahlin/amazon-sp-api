...
import io.swagger.client.model.SupportedDocumentSpecification;
 ...
 */
@ApiModel(description = "A list of the document specifications supported for a shipment service offering.")
