...
public class PlacementOption {
  ...
  **/
   ...
   * @return expiration
  **/
  @ApiModelProperty(value = "The expiration date of the placement option. In [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) datetime format with pattern `yyyy-MM-ddTHH:mm:ss.sssZ`.")
   ...
   * @return fees
  **/
  @ApiModelProperty(required = true, value = "The fee for the offered option.")
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "The status of a placement option. Possible values: `OFFERED`, `ACCEPTED`, `EXPIRED`.")
