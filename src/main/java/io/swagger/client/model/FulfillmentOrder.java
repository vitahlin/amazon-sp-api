...
import io.swagger.client.model.FulfillmentOrderStatus;
...
public class FulfillmentOrder {
  ...
  **/
  @ApiModelProperty(required = true, value = "The date and time that the status of the fulfillment order last changed. Must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.")
