...
import io.swagger.client.model.CODSettings;
import io.swagger.client.model.CreateFulfillmentOrderItemList;
import io.swagger.client.model.DeliveryPreferences;
import io.swagger.client.model.DeliveryWindow;
import io.swagger.client.model.FeatureSettings;
import io.swagger.client.model.FulfillmentAction;
import io.swagger.client.model.FulfillmentPolicy;
import io.swagger.client.model.NotificationEmailList;
...
public class CreateFulfillmentOrderRequest {
  ...
  **/
  @ApiModelProperty(value = "The delivery preferences applied to the destination address. These preferences will be applied when possible and are best effort. This feature is currently supported only in the JP marketplace and not applicable for other marketplaces.")
  ...
  **/
  @ApiModelProperty(value = "An array of various payment attributes related to this fulfillment order. This property is required if the order is placed against the India marketplace.")
