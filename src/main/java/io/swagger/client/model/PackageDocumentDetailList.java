...
import io.swagger.client.model.PackageDocumentDetail;
 ...
 */
@ApiModel(description = "A list of post-purchase details about a package that will be shipped using a shipping service.")
