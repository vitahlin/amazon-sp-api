...
public class InboundPlanSummary {
   ...
   * @return createdAt
  **/
  @ApiModelProperty(required = true, value = "The time at which the inbound plan was created. In [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) datetime format with pattern `yyyy-MM-ddTHH:mm:ssZ`.")
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "The current status of the inbound plan. Possible values: `ACTIVE`, `VOIDED`, `SHIPPED`, `ERRORED`.")
